...
// Convert date to Persion format
    ...
    <AuthWrapper>
      <div className="bg-shop-bg dark:bg-[#171a26] min-h-[100vh]">
        ...
        <div className="container py-4 px-10">
          {loading && <Loading />}
          {<section className="dark:bg-[#171a26]">
            {user.image ? (
              ...
              <div className="mt-4 flex justify-center">
                <img src="../../uploads/profile.png" alt="Profile Preview" className="w-32 h-32 rounded-full object-cover" />
              </div>
            )}
            {error && <p className="text-red-500">{error}</p>}
            {user && (
              <div>
                <div className="bg-white dark:bg-[#22232d]  text-gray-700 dark:text-gray-200 p-6 rounded-lg shadow-md">
