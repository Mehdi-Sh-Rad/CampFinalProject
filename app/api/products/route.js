...
export async function POST(request) {
  try {
    ...
    const discountPrice = data.get("discountPrice")
      ? parseFloat(data.get("discountPrice"))
      : undefined;
    ...
    if (!name || name.trim() === "") {
      return new Response(JSON.stringify({ message: "نام محصول الزامی است" }), {
        status: 400,
      });
    }
<<<<<<< Updated upstream
=======
    ...
    if (!nameRegex.test(name)) {
      return NextResponse.json(
        { message: "نام میتواند شامل حروف ، اعداد و فاصله باشد" },
        { status: 400 }
      );
    }
>>>>>>> Stashed changes
    if (name.length < 3 || name.length > 30) {
      return new Response(
        JSON.stringify({ message: "نام محصول باید بین 3 تا 30 کاراکتر باشد" }),
        { status: 400 }
      );
    }
    ...
    if (!author || author.trim() === "") {
      return new Response(
        JSON.stringify({ message: "نام نویسنده الزامی است" }),
        { status: 400 }
      );
    }
    if (author.length < 3 || author.length > 50) {
      return new Response(
        JSON.stringify({
          message: "نام نویسنده باید بین 3 تا 50 کاراکتر باشد",
        }),
        { status: 400 }
      );
    }
...
=======
    ...
    if (!authorRegex.test(author)) {
      return NextResponse.json(
        { message: "نام نویسنده میتواند شامل حروف ، اعداد و فاصله باشد" },
        { status: 400 }
      );
    }
...
>>>>>>> Stashed changes
    if (!description || description.trim() === "") {
      return new Response(
        JSON.stringify({ message: "توضیحات محصول الزامی است" }),
        { status: 400 }
      );
    }
    if (description.length < 3 || description.length > 500) {
      return new Response(
        JSON.stringify({
          message: "توضیحات محصول باید بین 3 تا 500 کاراکتر باشد",
        }),
        { status: 400 }
      );
    }
...
=======
    ...
    if (!descriptionRegex.test(description)) {
      return NextResponse.json(
        { message: "توضیحات محصول میتواند شامل حروف ، اعداد و فاصله باشد" },
        { status: 400 }
      );
    }
...
>>>>>>> Stashed changes
    if (!category) {
      return new Response(
        JSON.stringify({ message: "انتخاب دسته‌بندی الزامی است" }),
        { status: 400 }
      );
    }
    ...
    if (!free && (!price || isNaN(price) || price <= 0)) {
      return new Response(
        JSON.stringify({
          message:
            "قیمت محصول باید مقدار مثبت باشد یا گزینه رایگان را انتخاب کنید",
        }),
        { status: 400 }
      );
    }
    if (
      ...
      return new Response(
        JSON.stringify({ message: "قیمت تخفیفی باید عدد مثبت باشد" }),
        { status: 400 }
      );
    }
    ...
    if (files.length > 10) {
      return new Response(
        JSON.stringify({ message: "حداکثر 10 فایل مجاز است" }),
        {
          status: 400,
        }
      );
    ...
    if (images.length > 10) {
      return new Response(
        JSON.stringify({ message: "حداکثر 10 تصویر مجاز است" }),
        {
          status: 400,
        }
      );
    ...
    if (tags.length === 0) {
      return new Response(
        JSON.stringify({ message: "حداقل یک برچسب الزامی است" }),
        { status: 400 }
      );
    }
