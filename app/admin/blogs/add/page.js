...
const AddBlogPost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(result.message || "خطا در افزودن مقاله");
      }

      setSuccess("مقاله با موفقیت اضافه شد");
      setError(null);
        ...
        <div className="container py-4 px-10 -mt-10 z-50 relative">
          <div className="bg-white py-4 px-4 rounded-lg shadow-xl shadow-[#112692]/5 dark:bg-shop-dark">
            <div className="max-w-[400px] bg-white dark:bg-shop-dark">
              ...
              {success && (
                <h3 className="text-green-500 text-center mb-4">{success}</h3>
              )}
              <form className="py-4" onSubmit={handleSubmit}>
                <div className="flex flex-col items-start gap-y-4 w-full">
                  ...
                  <div className="relative w-full">
                    ...
                    >
                      {image ? image.name : "تصویری انتخاب نشده"}
                    </span>
                  </div>
